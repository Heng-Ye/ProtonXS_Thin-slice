...
h = TH1D("h", "", 150,0.5,1.5)
hTrue = TH1D("hTrue", "", 150,0.5,1.5)
true_vs_reco = TH2D("true_vs_reco", "", 150,0.5,1.5,150,0.5,1.5)

r = TH1D("r", "", 200,-1.,1.)
r_vs_true = TH2D("r_vs_true", "", 150,0.5,1.5, 200,-1.,1.)
r_vs_p = TH2D("r_vs_p", "", 150,0.5,1.5, 200,-1.,1.)

hF1 = TH1D("hF1", "", 192, 0, 192)
hF2 = TH1D("hF2", "", 192, 0, 192)
hF3 = TH1D("hF3", "", 192, 0, 192)
...
hPiRes = gDirectory.Get("hPiRes")
hProtRes = gDirectory.Get("hProtRes")
hElecRes = gDirectory.Get("hElecRes")
