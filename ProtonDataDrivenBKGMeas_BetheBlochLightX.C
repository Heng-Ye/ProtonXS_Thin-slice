#define ProtonDataDrivenBKGMeas_BetheBlochLight_cxx
#include "ProtonDataDrivenBKGMeas_BetheBlochLight.h"
...
void ProtonDataDrivenBKGMeas_BetheBlochLight::Loop() {
	if (fChain == 0) return;
	...
	//Name of output file ------------------------------------------------------------------------------------------------------------//
	TString str_out=Form("mc_kecalobkg_bmrw_beamxy_new7.root"); //allow ke<0 and set ke=-700 if under-estimation of keff
