#define ProtonBKGFractionCounter_cxx
#include "ProtonBKGFractionCounter.h"
...
void ProtonBKGFractionCounter::Loop() {
	if (fChain == 0) return;
	...
	for (Long64_t jentry=0; jentry<nentries;jentry++) { //main entry loop
		...
		if (IsPureInEL) { //is pure inelastic
			...
			//counting -- summary -----------------------------------------------------//
			cout<<"\nn_inc_tot:"<<n_inc_tot<<endl;
			cout<<"\nn_inc_misidp:"<<n_inc_misidp<<endl;
			cout<<"\nn_int_tot:"<<n_int_tot<<endl;
			cout<<"\nn_int_misidp:"<<n_int_misidp<<endl;
			cout<<"\nn_int_el:"<<n_int_el<<endl;
			cout<<"\nn_int_inel:"<<n_int_inel<<endl;
