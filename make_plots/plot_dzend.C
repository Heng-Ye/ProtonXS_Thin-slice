...
void plot_dzend(TString fin, TString fout_path, TString str_cut) {
	...
	TH1D *z_inel=(TH1D *)f0->Get(Form("dzend_inel_%s",str_cut.Data()));
	TH1D *z_el=(TH1D *)f0->Get(Form("dzend_el_%s",str_cut.Data()));
	TH1D *z_mcs=(TH1D *)f0->Get(Form("dzend_mcs_%s",str_cut.Data()));

	TH1D *z_midcosmic=(TH1D *)f0->Get(Form("dzend_midcosmic_%s",str_cut.Data()));
	TH1D *z_midpi=(TH1D *)f0->Get(Form("dzend_midpi_%s",str_cut.Data()));
	TH1D *z_midp=(TH1D *)f0->Get(Form("dzend_midp_%s",str_cut.Data()));

	TH1D *z_midmu=(TH1D *)f0->Get(Form("dzend_midmu_%s",str_cut.Data()));
	TH1D *z_mideg=(TH1D *)f0->Get(Form("dzend_mideg_%s",str_cut.Data()));
	TH1D *z_midother=(TH1D *)f0->Get(Form("dzend_midother_%s",str_cut.Data()));
	...
	z_mcs->GetXaxis()->SetTitle("Reco EndZ - Truth EndZ [cm]");
	...
	c_->Print(Form("%s/dzend_%s.eps",fout_path.Data(),str_cut.Data()));
