...
uf_bayes_int.SetLineColor(42)
uf_bayes_int.SetMarkerColor(42)
...
uf_bayes_inc.SetLineColor(42)
uf_bayes_inc.SetMarkerColor(42)
...
uf_bayes_inc_st.SetLineColor(42)
uf_bayes_inc_st.SetMarkerColor(42)
...
leg_int.AddEntry(reco_int, 'Reco (before unfolding)', "l")
leg_int.AddEntry(unf_int, 'Reco (after Weiner SVD unfolding)', "l")
leg_int.AddEntry(uf_bayes_int, 'Reco (after Bayesian unfolding)', "l")
leg_int.Draw()
...
leg_inc.AddEntry(uf_bayes_inc, 'Reco (after Bayesian unfolding)', "l")
leg_inc.Draw()
...
leg_inc_st.AddEntry(uf_bayes_inc_st, 'Reco (after Bayesian unfolding)', "l")
leg_inc_st.Draw()
