...
//reco_3D inc
TH3D *h3d_recosliceid;
TH3D *h3d_recosliceid_el;
TH3D *h3d_recosliceid_midp;
TH3D *h3d_recosliceid_inel;
TH3D *h3d_recosliceid_midcosmic;
TH3D *h3d_recosliceid_midpi;
TH3D *h3d_recosliceid_midmu;
TH3D *h3d_recosliceid_mideg;
TH3D *h3d_recosliceid_midother;
...
void BookHistograms() { //BookHistograms
	...
	h3d_recosliceid = new TH3D("h3d_recosliceid","h3d_recosliceid; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_inel = new TH3D("h3d_recosliceid_inel","h3d_recosliceid_inel; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_el = new TH3D("h3d_recosliceid_el","h3d_recosliceid_el; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_midcosmic = new TH3D("h3d_recosliceid_midcosmic","h3d_recosliceid_midcosmic; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_midpi = new TH3D("h3d_recosliceid_midpi","h3d_recosliceid_midpi; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_midp = new TH3D("h3d_recosliceid_midp","h3d_recosliceid_midp; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_midmu = new TH3D("h3d_recosliceid_midmu","h3d_recosliceid_midmu; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_mideg = new TH3D("h3d_recosliceid_mideg","h3d_recosliceid_mideg; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
	h3d_recosliceid_midother = new TH3D("h3d_recosliceid_midother","h3d_recosliceid_midother; Reco INC Start SliceID; Reco INC End SliceID; Reco INT SliceID", nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1, nthinslices + 2, -1, nthinslices + 1);
...
*/
	...
	h3d_recosliceid->Sumw2();
	h3d_recosliceid_el->Sumw2();
	h3d_recosliceid_midp->Sumw2();
	h3d_recosliceid_inel->Sumw2();
	h3d_recosliceid_midcosmic->Sumw2();
	h3d_recosliceid_midpi->Sumw2();
	h3d_recosliceid_midmu->Sumw2();
	h3d_recosliceid_mideg->Sumw2();
	h3d_recosliceid_midother->Sumw2();
