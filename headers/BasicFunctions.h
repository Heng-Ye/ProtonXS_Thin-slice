...
TFile *f_sys_bmrw=new TFile(Form("%sbmrw_sys.root", bmrw_path.Data()));
TF1 *kerw_cen=(TF1 *)f_sys_bmrw->Get("kerw_cen");
TF1 *kerw_max=(TF1 *)f_sys_bmrw->Get("kerw_max");
TF1 *kerw_min=(TF1 *)f_sys_bmrw->Get("kerw_min");
